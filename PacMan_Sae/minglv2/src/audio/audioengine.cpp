...
void nsAudio::AudioEngine::setMusic(const std::string& fileName, bool loop /* = true */)
{
    ...
    // put as a commentary because function not found and it break the program ( the latest version in which the method apper is 2.6.1 )
        // m_music.setLoop(loop);
    // this seem to be the new version of setLoop(bool loop)
